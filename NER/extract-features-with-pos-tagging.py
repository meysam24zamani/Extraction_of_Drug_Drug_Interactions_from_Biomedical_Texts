...
def pos(inputString):
    tag = nltk.pos_tag(word_tokenize(inputString))[0][1]
...
def extract_features(tokens) :
   ...
   for k in range(0,len(tokens)):
      ...
      #tokenFeatures.append("pre3="+t[:3]) #new
      tokenFeatures.append("pre4="+t[:4]) #new
      tokenFeatures.append("length:"+str(len(t)))
      tokenFeatures.append("PoS:"+pos(t))
      ...
      #if (t.isalpha()) : tokenFeatures.append("isAlpha") # new, all characters are in alphabet, no digits or special chars
      ...
      if k>0 :
         ...
         #tokenFeatures.append("pre3="+tPrev[:3]) #new
         #tokenFeatures.append("pre4="+tPrev[:4]) #new
         tokenFeatures.append("lengthPrev:"+str(len(tPrev)))
         tokenFeatures.append("PoSPrev:"+pos(tPrev))
         ...
         #if (tPrev.isalpha()) : tokenFeatures.append("isAlphaPrev") #new
         #if (hasdigit(tPrev)) : tokenFeatures.append("hasDigitPrev")
         #if (hasdash(tPrev)) : tokenFeatures.append("hasDashPrev")
      else :
      ...
      if k<len(tokens)-1 :
         ...
         #tokenFeatures.append("pre3Next="+tNext[:3]) #new
         #tokenFeatures.append("pre4Next="+tNext[:4]) #new
         tokenFeatures.append("lengthNext:"+str(len(tNext)))
         tokenFeatures.append("PoSNext:"+pos(tNext))
         ...
         #if (tNext.isalpha()) : tokenFeatures.append("isAlphaNext") #new
         #if (hasdigit(tNext)) : tokenFeatures.append("hasDigitNext") 
         #if (hasdash(tNext)) : tokenFeatures.append("hasDashNext")
      else:
